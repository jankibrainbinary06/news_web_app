              ...
              children: [
                ...
                Container(
                  ...
                  Column(
                    ...
                    children: [
                      Text('Sports',
                        style: poppinsBold.copyWith(fontWeight: FontWeight.w900,
                            fontSize: 20,
                      ...
                      Expanded(
                        child: GridView.builder(
                          ...
                          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                            crossAxisCount: 2,
                            crossAxisSpacing: Get.width > 1850 ? 500 : (Get
                                .width > 1520 && Get.height <= 1850) ? 200 : 0,
                          ...
                          return SizedBox(
                            ...
                            child: Row(
                              children: [
                                ...
                                SizedBox(
                                  width: sizingInformation.isMobile ? 5 : 15,),
                                GestureDetector(
                                    onTap: () {
                                      showDialog(
                                        context:
                                ...
                                GestureDetector(
                                              ...
                                              Container(
                                                ...
                                                Column(
                                                  children: [
                                                    ...
                                                    Text(
                                                      'Are you sure want to delete ${dashboardController
                                    ...
                                    child: Image.asset(AssetRes.delete,
                                      height: sizingInformation.isMobile
                                          ? 15
                                          : 20,
                                      width: sizingInformation.isMobile
                      ...
                      Expanded(
                        child: GridView.builder(
                          ...
                          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                            crossAxisCount: 2,
                            crossAxisSpacing: Get.width > 1850 ? 500 : (Get
                                .width > 1520 && Get.height <= 1850) ? 200 : 20,
                            ...
                            child: Row(
                              children: [
                                Expanded(
                                  child: GestureDetector(
                                    onTap: () {
                                      dashboardController.isTapCategory = true;
                                      dashboardController.update(['dash']);
                                    },
                                    child: Container(
                                      width: Get.width > 1150
                                ...
                                GestureDetector(
                                    onTap: () {
                                      dashboardController.editCategoryController
                                          .text =
                                      dashboardController.categoryList[index]
                                      ;
                                      showDialog(
